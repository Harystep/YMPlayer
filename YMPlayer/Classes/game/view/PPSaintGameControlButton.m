...
- (void)showSaintShootBt {
    ...
    self.actionLogoImage = [PPImageUtil imageNamed:@"player_flight_op_icon"];
}
- (void)showSaintRaisebetBt {
    [self theControlBgView];
    self.actionLogoImage = [PPImageUtil imageNamed:@"player_double_speed_icon"];
}
- (void)showPushCoinBt {
    [self theControlBgView];
    self.actionLogoImage = [PPImageUtil imageNamed:@"player_insert_coin_icon"];
}
#pragma mark - set
