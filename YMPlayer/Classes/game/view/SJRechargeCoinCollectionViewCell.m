...
- (void)loadCoinModel:(PPChargetCoinData * )data{
    ...
    if(self.chargetCointData.type == 100001) {
        bgIconStr = [NSString convertImageNameWithLanguage:@"img_coin_recharge_day_content_bg_a"];
        color = RGBACOLOR(102, 23, 23, 1);
    } else if (self.chargetCointData.type == 100002) {
        bgIconStr = [NSString convertImageNameWithLanguage:@"img_coin_recharge_week_content_bg_a"];
        color = RGBACOLOR(102, 45, 23, 1);
    } else if (self.chargetCointData.type == 100003) {
        bgIconStr = [NSString convertImageNameWithLanguage:@"img_coin_recharge_month_content_bg_a"];
        color = RGBACOLOR(102, 23, 23, 1);
    } else {
