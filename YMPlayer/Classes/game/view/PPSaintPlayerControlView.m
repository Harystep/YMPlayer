...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.frame = CGRectMake(0, 0, SCREEN_WIDTH, DSize(400));
        [self configView];
        [self configData];
    }
    return self;
...
- (void)showTouchDirctionView:(SDMoveDirctionType ) actionType {
    ...
    if (actionType == SDMoveDirctionLeft) {
        ...
        self.theDirctionImageView.image = [PPImageUtil imageNamed:@"player_roulette_left"];
        ...
        self.theDirctionImageView.image = [PPImageUtil imageNamed:@"player_roulette_up"];
        ...
        self.theDirctionImageView.frame = CGRectMake(0, 0, DSize(80), DSize(190));
        self.theDirctionImageView.image = [PPImageUtil imageNamed:@"player_roulette_right"];
        ...
        self.theDirctionImageView.frame = CGRectMake(0, 0, DSize(190), DSize(80));
        self.theDirctionImageView.image = [PPImageUtil imageNamed:@"player_roulette_down"];
...
- (void)rouletteItemClick:(UIButton *)sender {
    SDMoveDirctionType actionType = sender.tag;
    if (self.lastDirction != actionType) {
        [[self touchThread] interrupt];
        if (self.currentDirction > 0 ) {
            [self.longTouchEndSubject sendNext:@(self.lastDirction)];
...
- (void)createPlayerRouletteView {
    UIImageView *upBtn = [[UIImageView alloc] initWithImage:[PPImageUtil imageNamed:@"player_roulette_up"]];
    [self.theControllDirctionBgImageView addSubview:upBtn];
    [upBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.theControllDirctionBgImageView.mas_centerX);
        make.height.width.mas_equalTo(42);
        make.top.mas_equalTo(self.theControllDirctionBgImageView.mas_top);
    }];
    upBtn.tag = SDMoveDirctionUp;
    
    UIImageView *downBtn = [[UIImageView alloc] initWithImage:[PPImageUtil imageNamed:@"player_roulette_down"]];
    [self.theControllDirctionBgImageView addSubview:downBtn];
    [downBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.theControllDirctionBgImageView.mas_centerX);
        make.height.width.mas_equalTo(42);
        make.bottom.mas_equalTo(self.theControllDirctionBgImageView.mas_bottom);
    }];
    downBtn.tag = SDMoveDirctionDown;
    
    UIImageView *leftBtn = [[UIImageView alloc] initWithImage:[PPImageUtil imageNamed:@"player_roulette_left"]];
    [self.theControllDirctionBgImageView addSubview:leftBtn];
    [leftBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.leading.mas_equalTo(self.theControllDirctionBgImageView.mas_leading);
        make.height.width.mas_equalTo(42);
        make.centerY.mas_equalTo(self.theControllDirctionBgImageView.mas_centerY);
    }];
    leftBtn.tag = SDMoveDirctionLeft;
    
    UIImageView *rightBtn = [[UIImageView alloc] initWithImage:[PPImageUtil imageNamed:@"player_roulette_right"]];
    [self.theControllDirctionBgImageView addSubview:rightBtn];
    [rightBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.trailing.mas_equalTo(self.theControllDirctionBgImageView.mas_trailing);
        make.height.width.mas_equalTo(42);
        make.centerY.mas_equalTo(self.theControllDirctionBgImageView.mas_centerY);
    }];
    rightBtn.tag = SDMoveDirctionRight;
}
...
- (UIImageView * )theControllDirctionBgImageView{
    if (!_theControllDirctionBgImageView) {
        //WithImage:[PPImageUtil imageNamed:@"ico_new_control_bg"]
...
- (PPSaintGameControlButton * )theRaisebetButton{
    if (!_theRaisebetButton) {
        ...
        [self addSubview:theView];
        [theView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.trailing.equalTo(self.theFireButton.mas_leading).inset(12);
            make.width.mas_equalTo(DSize(84));
            make.height.mas_equalTo(DSize(84));
            make.top.mas_equalTo(self.theFireButton.mas_top).offset(6);
...
- (PPSaintGameControlButton * )thePushCoinButton{
    if (!_thePushCoinButton) {
        ...
        [self addSubview:theView];
        [theView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.leading.equalTo(self.theRaisebetButton.mas_leading).offset(DSize(56));
            make.width.mas_equalTo(DSize(84));
            make.height.mas_equalTo(DSize(84));
            make.bottom.equalTo(self.theFireButton.mas_top).inset(3);
        }];
        theView.tag = 7;
...
- (PPSaintPushCoinView *)theSaintPushCoinView{
    if (!_theSaintPushCoinView) {
        ...
        [self addSubview:theView];
        [theView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.leading.equalTo(self.thePushCoinButton.mas_trailing).offset(DSize(20));
            make.bottom.equalTo(self.thePushCoinButton.mas_bottom).inset(10);
            make.width.mas_equalTo(DSize(60));
            make.height.mas_equalTo(DSize(240));
        }];
