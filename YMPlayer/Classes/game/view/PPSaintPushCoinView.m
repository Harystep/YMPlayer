...
- (UIButton *)pushCoin5Button{
    if (!_pushCoin5Button) {
        ...
        theView.layer.cornerRadius = DSize(30);
        [theView setTitle:@"+20" forState:UIControlStateNormal];
        theView.titleLabel.font = [UIFont fontWithName:@"Alfa Slab One" size:14];
        theView.titleLabel.font = [UIFont boldSystemFontOfSize:14];
        theView.tag = 3;
        theView.alpha = 0;
        theView.backgroundColor = [UIColor colorWithRed:220.0/255.0 green:154/255.0 blue:37/255.0 alpha:1.0];
